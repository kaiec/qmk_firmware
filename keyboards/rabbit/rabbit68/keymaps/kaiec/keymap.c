...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_NO,            KC_SPC,  KC_SPC,           KC_RALT, MO(_FN), KC_LCTL, KC_LEFT, KC_DOWN, KC_RIGHT
  ),
    [_FN] = LAYOUT(
  _______, KC_F1,      KC_F2,      KC_F3,       KC_F4,      KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______, _______, _______,
  _______, KC_MS_BTN1, KC_MS_UP,   KC_MS_BTN2,  KC_MS_BTN3, _______, _______, _______, _______, _______, _______, _______, _______, _______,
